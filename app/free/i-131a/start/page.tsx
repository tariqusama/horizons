              ...
              <>
                ...
                <div className="mb-10">
                  ...
                  <div className="space-y-4">
                    <label
                      className={`flex items-center p-5 border-2 rounded-xl cursor-pointer transition-all duration-200 ${selectedOption === 'yes'
                          ? 'border-orange-500 bg-orange-50'
                          : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                        }`}
                      onClick={() => setSelectedOption('yes')}
                    >
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-4 shrink-0 transition-colors ${selectedOption === 'yes' ? 'border-orange-500 bg-orange-500' : 'border-gray-300'
                        }`}>
                    ...
                    <label
                      className={`flex items-center p-5 border-2 rounded-xl cursor-pointer transition-all duration-200 ${selectedOption === 'no'
                          ? 'border-orange-500 bg-orange-50'
                          : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                        }`}
                      onClick={() => setSelectedOption('no')}
                    >
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-4 shrink-0 transition-colors ${selectedOption === 'no' ? 'border-orange-500 bg-orange-500' : 'border-gray-300'
                        }`}>
                ...
                <div className="flex items-center justify-end pt-6 border-t border-gray-100">
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      onClick={handleNext}
                      className={`font-bold px-6 py-3 rounded-xl transition-colors shadow-md flex items-center ${selectedOption ? 'bg-[#1B3A64] hover:bg-[#0A192F] text-white' : 'bg-gray-200 text-gray-400 cursor-not-allowed'
                        }`}
                    >
                      Review
            ...
            {step === 'review' && (
              <div className="animate-fade-in">
                ...
                <div className="mb-8 border-b border-gray-100 pb-6 text-center">
                  ...
                  <p className="text-[#5A6579]">Please double-check your answers before continuing to the USCIS guidance.</p>
                </div>
                ...
                <div className="flex justify-center pt-8">
                  <button
                    type="button"
                    onClick={() => {
                      window.location.href = 'https://www.uscis.gov/i-131a';
                    }}
