      ...
      <div className="max-w-[1000px] mx-auto px-4 py-12">
        ...
        <div className="max-w-[800px] mx-auto space-y-10">
          ...
          <form className="space-y-6">
              ...
              <div className="p-6 lg:p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <input className="w-full h-12 bg-gray-50 border border-gray-200 rounded-lg px-4 focus:outline-none focus:ring-2 focus:ring-[#1B3A64] transition-all" placeholder="Maria" name="firstName" id="firstName" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input className="w-full h-12 bg-gray-50 border border-gray-200 rounded-lg px-4 focus:outline-none focus:ring-2 focus:ring-[#1B3A64] transition-all" placeholder="Lopez" name="lastName" id="lastName" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="p-6 lg:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="email" className="w-full h-12 bg-gray-50 border border-gray-200 rounded-lg px-4 focus:outline-none focus:ring-2 focus:ring-[#1B3A64] transition-all" placeholder="maria@example.com" name="email" id="email" />
            ...
            <div className="pt-6">
              <button className="w-full bg-[#FF5A1F] hover:bg-[#E04512] text-white font-bold h-14 rounded-xl text-lg shadow-md transition-colors" type="button">
                Continue to Review
              </button>
            </div>
          </form>
