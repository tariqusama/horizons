                                                        ...
                                                        <div className="flex items-center justify-between gap-4">
                                                            ...
                                                            {doc.file_path && (
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <a href={getStorageUrl(doc.file_path)} download target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1 bg-blue-50 px-3 py-1.5 rounded-full transition-colors hover:bg-blue-100">
