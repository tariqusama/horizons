            ...
            <div className="flex-1 min-w-0 flex flex-col">
                ...
                <header className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 lg:px-8 py-3 sm:py-4 mb-2 bg-white rounded-2xl shadow-sm">
                    ...
                    <div className="relative shrink-0">
                        ...
                        {showNotifications && (
                            <div className="absolute right-[-2rem] sm:right-0 mt-2 w-[calc(100vw-2rem)] sm:w-[320px] bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden z-50">
