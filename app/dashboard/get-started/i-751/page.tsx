...
export default function I751FormPage() {
    ...
    const handleNext = async (e: React.MouseEvent) => {
        ...
        try {
            ...
            const next = getNextFormPath('/dashboard/get-started/i-751', latest?.title || '');
            router.push(next);
        } catch (error: any) {
    ...
    return (
        <div className={styles.pageWrapper}>
            ...
            <div className={styles.footerScreenshot}>
                <button onClick={() => { const prev = getPrevFormPath('/dashboard/get-started/i-751', applicationTitle); router.push(prev); }} className={styles.btnTeal}>
                    &#8592; Previous
                </button>
